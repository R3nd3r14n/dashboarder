...
fn main() {
    ...
    // 2. NAČTENÍ KONFIGURACE (z mqtt_bridge_roomtemp.toml)
    let full_config: serde_json::Value =
        load_config("mqtt_bridge_roomtemp").expect("Konfigurace nebyla nalezena");
    ...
    let service_name = "mqtt-bridge-roomtemp";
